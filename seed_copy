...
Category.create(age_group_id: kids.id, gender: "m", description: "He loves watching tom n jerry. But also enjoys the suspence lying around in the kids next door.", name: "Music & Movies", image_url: "http://il2.picdn.net/shutterstock/videos/15449185/thumb/1.jpg")
...
Category.create(age_group_id: kids_f.id, gender: "f", description: "'I am barbie girl in the barbie world ... ' she brushes her hair while singing her favourite song, getting all dressed for the next barbie movie. She can't wait!", name: "Music & Movies", image_url: "http://www.frillylily.co.uk/1879-atmn_normal/titania-fairy-princess-dress-pink-girls.jpg")
...
Category.create(age_group_id: adults.id, gender: "m", description: "'MMM...rahul naam toh suna hoga' - mimics SRK all the time. But aspires a brad pitt body.  He loves listening to bollywood numbers and is always found dancing around in the house", name: "Music & Movies", image_url: "http://images.indianexpress.com/2016/04/srk-ddlj1.jpg")
...
Category.create(age_group_id: old_agers.id, gender: "m", description: "He watches black and white movies and enjoys subtle romantic music. He listens to them while resting on his arm chair relaxing.", name: "Music & Movies", image_url: "http://www.businessnow.ro/wp-content/uploads/2016/06/muzica-digitala.png")

...
teenagers_f = AgeGroup.create(min_age: 13, max_age: 19, title: "Teen Agers", gender: 'f', image: 'teenager_f.jpg')
adults_f = AgeGroup.create(min_age: 20, max_age: 28, title: "Adults", gender: 'f', image: 'adult_f.jpg')
old_agers_f = AgeGroup.create(min_age: 29, max_age: nil, title: "Old Age", gender: 'f', image: 'old_f.jpg')
...
Category.create(age_group_id: kids_f.id, gender: "f", description: "She is jumping and rolling all over the bed. Cartwheeling and doing flexible excersizes is her routine" , name: "Sports", image_url: "")

Category.create(age_group_id: kids_f.id, gender: "f", description: "'I am barbie girl in the barbie world ... ' she brushes her hair while singing her favourite song, getting all dressed for the next barbie movie. She can't wait!", name: "Music & Movies", image_url: "")

Category.create(age_group_id: kids_f.id, gender: "f", description: "She is playing with her kitchen set, trying to copy her mom. Mixing parle biscuits with water is one of her favourite dishes.", name: "Foodie", image_url: "")

Category.create(age_group_id: kids_f.id, gender: "f", description: "She want to dress like the cindrella. Shining teara and beautiful pink frock is the best combination. She is definately going to win the fancy dress competition ", name: "Fashion", image_url: "")

Category.create(age_group_id: kids_f.id, gender: "f", description: "She loves making necklaces and bracelets with beads. She makes it for her mom , her friends and her teacher. ",  name: "Handcraft", image_url: "")
...
Category.create(age_group_id: kids_f.id, gender: "f", description: "",  name: "Other", image_url: "")
...
Category.create(age_group_id: teenagers_f.id, gender: "f", description: "She is crazy about taylor swift. Taylor's songs are always on her lips. Are we looking at a young star?. Who knows!", name: "Music & Movies", image_url: "")
...
Category.create(age_group_id: teenagers_f.id, gender: "f", description: "",  name: "Other", image_url: "")
...
Category.create(age_group_id: adults_f.id, gender: "f", description: "She goes gaga seeing hrithik roshan on screen. She never misses any of her movies. Her room is painted with his posters. She claims to be her biggest fan!", name: "Music & Movies", image_url: "")
...
Category.create(age_group_id: adults_f.id, gender: "f", description: "",  name: "Other", image_url: "")
...
Category.create(age_group_id: old_agers_f.id, gender: "f", description: "She is a professional choreographer. She organizes musical plays for schools and loves watching dance movies with her kids.", name: "Music & Movies", image_url: "")
...
Category.create(age_group_id: old_agers_f.id, gender: "f", description: "",  name: "Other", image_url: "")

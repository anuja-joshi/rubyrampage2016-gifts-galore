...
kids = AgeGroup.create(min_age: 2, max_age: 12, title: "kids", gender: 'm', image: "kids_m.jpg", description: 'They are innoncent and exuberant. They find happiness in small things, whether its a chocolate or their favourite cartoon character toy. Bringing joy in their lives is easy, all we need to do is find them the apt gift. Gifts that bring the biggest smile on their face. Gifts that allow them to explore their interests. Gifts that nourish them with qualities today to enrich their future tomorrow.')
teenagers = AgeGroup.create(min_age: 13, max_age: 19, title: "teenagers", gender: 'm', image: "teenager_m.jpg", description: 'They are young and credible. Highly influenced by the world around, they try coping with the latest living ways. Trending and molding themselves into a cool personality is what they seek. Gifts that help them achieve these desires is what you should look for. Find the most unique but latest collection with us.')
adults = AgeGroup.create(min_age: 20, max_age: 28, title: "youngsters", gender: 'm', image: "adult_m.jpg", description: 'They are independent and strong. Their individuality is the reflection of their personality. Tied by their specific and peculiar interests, gifts that would help them stand out and personify them is what you seek. Find their interests and look for the best possible match from our surplus collection.')
old_agers = AgeGroup.create(min_age: 29, max_age: nil, title: "adults", gender: 'm', image: "old_m.jpg", description: 'Their altruistic nature may sometimes deny them of following their heart completely. They have always cared and lived for their young ones. Its time to return this immorrtal love. Encourage them to follow their heart and dreams by gifting them what they have always wanted. Dig into our abundant collection of beatiful gestures.')


kids_f = AgeGroup.create(min_age: 2, max_age: 12, title: "kids", gender: 'f', image: 'kids_f.jpg', description: 'They are innoncent and exuberant. They find happiness in small things, whether its a chocolate or their favourite cartoon character toy. Bringing joy in their lives is easy, all we need to do is find them the apt gift. Gifts that bring the biggest smile on their face. Gifts that allow them to explore their interests. Gifts that nourish them with qualities today to enrich their future tomorrow.')
teenagers_f = AgeGroup.create(min_age: 13, max_age: 19, title: "teenagers", gender: 'f', image: 'teenager_f.jpg', description: 'They are young and credible. Highly influenced by the world around, they try coping with the latest living ways. Trending and molding themselves into a cool personality is what they seek. Gifts that help them achieve these desires is what you should look for. Find the most unique but latest collection with us.')
adults_f = AgeGroup.create(min_age: 20, max_age: 28, title: "youngsters", gender: 'f', image: 'adult_f.jpg', description: 'They are independent and strong. Their individuality is the reflection of their personality. Tied by their specific and peculiar interests, gifts that would help them stand out and personify them is what you seek. Find their interests and look for the best possible match from our surplus collection.')
old_agers_f = AgeGroup.create(min_age: 29, max_age: nil, title: "adults", gender: 'f', image: 'old_f.jpg', description: 'Their altruistic nature may sometimes deny them of following their heart completely. They have always cared and lived for their young ones. Its time to return this immorrtal love. Encourage them to follow their heart and dreams by gifting them what they have always wanted. Dig into our abundant collection of beatiful gestures.')
